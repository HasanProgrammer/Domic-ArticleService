...
namespace Karami.Persistence.Migrations.C
{
    ...
    [Migration("20230331081016_CreateTablesVersion_1_0_0")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Karami.Domain.Article.Entities.Article", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Karami.Domain.File.Entities.File", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Karami.Domain.Article.Entities.Article", b =>
                {
                    ...
                    b.OwnsOne("Karami.Domain.Article.ValueObjects.Body", "Body", b1 =>
                        {
                            b1.Property<string>("ArticleId")
                                .HasColumnType("nvarchar(450)");
                    ...
                    b.OwnsOne("Karami.Domain.Article.ValueObjects.Summary", "Summary", b1 =>
                        {
                            b1.Property<string>("ArticleId")
                                .HasColumnType("nvarchar(450)");
                    ...
                    b.OwnsOne("Karami.Domain.Article.ValueObjects.Title", "Title", b1 =>
                        {
                            b1.Property<string>("ArticleId")
                                .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Karami.Domain.File.Entities.File", b =>
                {
                    b.HasOne("Karami.Domain.Article.Entities.Article", "Article")
                        .WithMany("Files")
                        .HasForeignKey("ArticleId")
                    ...
                    b.OwnsOne("Karami.Domain.File.ValueObjects.Extension", "Extension", b1 =>
                        {
                            b1.Property<string>("FileId")
                                .HasColumnType("nvarchar(450)");
                    ...
                    b.OwnsOne("Karami.Domain.File.ValueObjects.Name", "Name", b1 =>
                        {
                            b1.Property<string>("FileId")
                                .HasColumnType("nvarchar(450)");
                    ...
                    b.OwnsOne("Karami.Domain.File.ValueObjects.Path", "Path", b1 =>
                        {
                            b1.Property<string>("FileId")
                                .HasColumnType("nvarchar(450)");
